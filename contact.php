...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://www.seostairs.com/contact" />
    <meta
      name="description"
      content="Connect with the best digital agency that your business needs. SEO Stairs offers complete SEO and web service packages with profitable results. "
    />
    <title>Contact SEO Stairs | Complete SEO and Web Service Packages</title>
    ...
    <main>
      <section id="contact">
        <div class="container">
          ...
          <div
            class="row row-cols-1 row-cols-md-2 row-cols-lg-4 text-center contact-medium"
          >
            <div class="col">
              <a href="tel:+19786376362" target="_blank">
            ...
            <div class="col">
              ...
              <h4>Address</h4>
              <p>
                Paradise Ridge Dr,<br />
                Round Rock 78665, Texas
              </p>
            </div>
            <div class="col">
              <a href="mailto:info@seostairs.com">
                <i class="bi bi-envelope"></i>
              </a>
              <h4>Email</h4>
              <p>info@seostairs.com</p>
            </div>
            <div class="col">
              <i class="bi bi-clock"></i>
              <h4>Open Hours</h4>
              <p>Mon-Fri: 7AM - 5PM <br />Sat-Sun: Closed</p>
            </div>
          </div>
        </div>
      </section>
